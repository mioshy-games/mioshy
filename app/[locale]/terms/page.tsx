...
export default async function TermsPage({
  ...
  const sections: LegalSection[] = SECTION_KEYS.map((key) => {
    // Read the whole section object once. Cheaper than three separate
    // t.raw calls AND avoids next-intl logging MISSING_MESSAGE for
    // sections that legitimately don't have a `list` (e.g. "ip"); a
    // missing optional sub-key would fire onError before the throw
    // could be caught.
