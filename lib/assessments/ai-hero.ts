...
== חיבור לליווי (חובה) ==
ה-hero חייב לקשור את התועלות לליווי של מיאושי - שהשינוי קורה דרך הליווי. שלב ביטוי כמו "בליווי עם מיאושי", "עם הליווי של מיאושי", או "כאן בליווי". בלי זה התוצאה פסולה.

== מבנה הפלט ==
hero_he: שורה אחת, 1-2 משפטים, 22-45 מילים, ממוקד בנושא האבחון, וקושר לליווי של מיאושי. אם expert_mentioned=true הוסף את משפט המומחה בסוף.
