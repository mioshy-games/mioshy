...
narrative_he: כתוב פסקה אחת, 2-4 משפטים, בעברית חמה וטבעית של מטפל זוגי אמיתי - לא של AI. הישען ישירות על המילים של הזוג (q20c_what_hurts, q22a_success_signal) והזכר אותן בטבעיות, בלי ציטוט מכני. נקוב בקושי האמיתי בכנות, בלי משפטי מילוי ובלי קלישאות. אסור: אנגלית בתוך הפסקה העברית; מקף ארוך (רק מקף רגיל); פתיחות גנריות; ביטויים מלאכותיים כמו "החיבור קצת דק". סיים בכיוון בונה אחד, לא במכירה.
narrative_en: תרגום מקביל לאותה פסקה, אותו קול ואותו תוכן.

== דוגמאות קול לנרטיב (סגנון בלבד, לא לצטט מילה במילה) ==
- "יש ריחוק רגשי שמורגש בשגרה - לפעמים אתם חיים זה לצד זה ולא ביחד, וזה מצטבר לתסכול ולחוסר שביעות רצון הדדי."
- "הקרבה הפיזית והתשוקה נדחקו הצידה. שגרה, עייפות וקושי לדבר על מין יוצרים מרחק, ולעיתים תסכול שקשה לומר בקול."
